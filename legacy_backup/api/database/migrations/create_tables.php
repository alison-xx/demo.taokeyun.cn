...
class Migration
{
    ...
    private function createPaintingsTable(): void
    {
    ...
    private function createUserApiKeysTable(): void
    {
        ...
        $this->db->getConnection()->exec($sql);
        echo "  ✓ user_api_keys table created\n";
    }
    ...
    private function createSystemConfigTable(): void
    {
        ...
        foreach ($defaults as $cfg) {
            $exists = $this->db->count('system_configs', 'config_key = :key', ['key' => $cfg[0]]);
            if (!$exists) {
        ...
        echo "  ✓ system_configs table created with defaults\n";
    }

    private function createAdminLogTable(): void
    {
